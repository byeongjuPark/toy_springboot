      ...
      '>
        <nav class='navbar'>
            <div class='container-fluid my-2 mx-5 align-items-start'>
                ...
                <a href='./survey' class='nav-link fs-5' style='width: 15%'>설문</a>
                <div style='width: 15%'>
                    ...
                    <div class='collapse navbar-collapse' id='collapseId'>
                        <div class='navbar-nav'>
                            <a href='/statisticsPrintUserServey' class='nav-link' style='color: RGB(106, 96, 169)'>회원 설문/답문 조회</a>
                            <a href='./statisticsUsersServey' class='nav-link' style='color: RGB(106, 96, 169)'>설문자별 통계</a>
                            <a href='./statisticsServey' class='nav-link' style='color: RGB(106, 96, 169)'>질문별 총 답변 수</a>
                        </div>
                    </div>
                </div>
